...
public class FECpacket {
	int FEC_group; // Number of media packages for a group
	byte[] data;
	int data_size;
	int packages;
	int to_frame;
	...
	void xordata(byte[] data, int data_length) { // accepts user data
	...
	int getdata(byte[] data) {
		...
		return data_size; // gets FEC packet (length -> longest media packet)
	}
	...
	// Recipient
	// separate buffers for media data and FEC
	// Buffer size should be a multiple of the group size
	...
	int get_missing_nr() {
		...
		// last package missing

		// System.err.println("No missing package found");
