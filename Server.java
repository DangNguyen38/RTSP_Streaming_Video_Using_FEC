...
public class Server extends JFrame implements ActionListener {
	...
	final static int FRAME_PERIOD = 40; // Frame period of the video to stream
	final static int VIDEO_LENGTH = 500; // length of the video in frames
	...
	public Server() {
		...
		// GUI:
		label = new JLabel("Send frame #        ", JLabel.CENTER);	//SendFrame-Label
	...
	public static void main(String argv[]) throws Exception {
		...
		if (argv.length == 0) {											// Check portnummer
			...
			String tmp;
			tmp = JOptionPane.showInputDialog("Port of the server (Standard 3333):");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (imagenb < VIDEO_LENGTH) {
			...
			try {
				...
				if (sbLossRate.getValue() < (new Random().nextFloat() * 100.)) {
